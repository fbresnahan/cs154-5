...
with pyrtl.conditional_assignment:
    with (reg_write_xm) & (rd_xm != 0):
        with rd_xm == rf_data_1_dx:
            forwardA |= 2
        with rd_xm == rf_data_2_dx:
            forwardB |= 2
    with (reg_write_mw) & (rd_mw != 0) & ~((reg_write_xm) & (rd_xm != 0) & (rd_xm == rf_data_1_dx)) & (rd_mw == rf_data_1_dx):
        forwardA |= 1
    with (reg_write_mw) & (rd_mw != 0) & ~((reg_write_xm) & (rd_xm != 0) & (rd_xm == rf_data_2_dx)) & (rd_mw == rf_data_2_dx):  
        forwardB |= 1
